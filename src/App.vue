...
onMounted(() => {
  ...
  // 全局颜色
  document.body.style.setProperty('--el-color-primary', '#2a9e88')
  document.body.style.setProperty('--el-color-primary-light-9', '#F5FBF0')
  document.body.style.setProperty('--el-color-primary-light-3', '#34b099')
  document.body.style.setProperty('--el-color-primary-dark-2', '#34b099')
  document.body.style.setProperty('--el-color-primary-light-5', '#94cfc4')
})
</script>
