...
const useMenuStore = defineStore(
  ...
  'menu',
  {
    state: () => ({
      ...
      actived: 0,
      subMenus: [] as any, // 子系统菜单
      openSubMenus: [] as any, // 默认展开子系统菜单
      subPath: '',
      tabActive: 0,
    }),
    getters: {
    ...
    actions: {
      ...
      // setSidebarMenus(index: any) {
      //   this.sidebarMenus(index)
      // },

      // 给子系统菜单赋值
      setSubMenus(data: any) {
        // console.log(data)
        // this.subMenus = []
        this.subMenus = data
      },
      ...
      // 默认展开子系统菜单
      setOpenSubMenus(data: any) {
        this.openSubMenus = getDefaultOpenedPaths(data)
      },
