      ...
      <el-form :inline="true" :model="formInline" class="demo-form-inline" label-width="100px">
        ...
        <el-row>
          <el-form-item label="报警级别：">
            <el-input v-model="formInline.levelId" placeholder="请选择报警级别" />
          </el-form-item>
          <el-form-item label="报警类型：">
            <el-input v-model="formInline.levelType" placeholder="请选择报警类型" />
          </el-form-item>
          <el-form-item label="处理状态：">
            <el-input v-model="formInline.handleState" placeholder="请选择处理状态" />
          </el-form-item>
        </el-row>
        <el-row>
