<!--
 * @Description:新增全自动方案弹窗
 * @Version: 1.0
 * @Autor: Jiang Wei
 * @Date: 2023-05-06 13:05:08
 * @LastEditors: Jiang Wei
 * @LastEditTime: 2024-03-21 13:36:13
-->
  ...
  >
    <el-form ref="ruleFormRef" :rules="rules" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="140px">
      ...
      <el-form-item label="所属控制系统：" prop="ddcId">
        <el-select v-model="infoDataForm.ddcId" filterable clearable placeholder="请选择" class="formInput">
