...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :rules="rules" :model="infoDataForm" class="demo-form-inline" label-width="100px">
      <el-form-item label="角色名称" placeholder="请输入" class="formInput" prop="name">
        <el-input v-model="infoDataForm.name" />
      </el-form-item>
      <el-form-item label="角色描述" placeholder="请输入" class="formInput">
        <el-input v-model="infoDataForm.describe" />
      </el-form-item>
    </el-form>
    <template #footer>
