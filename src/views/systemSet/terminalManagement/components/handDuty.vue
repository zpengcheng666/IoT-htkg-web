...
<template>
  <div class="common-layout">
    <el-card class="box-card">
      ...
      <div class="text item notice" style="padding: 0 0.85rem;border-bottom: solid 1px #fff;">
        <div class="box-card-child-info" >
      ...
      <vue3-seamless-scroll v-if="props.infoData.length > 0" :limit-scroll-num="3" step="0.5" class="list_box"
        :list="props.infoData">

        <div v-for="item in props.infoData.length > 4 ? props.infoData : props.infoData.slice(0, 4)"
          v-show="props.infoData.length > 0" :key="item.id" class="text item notice">
      ...
      <div v-show="props.infoData.length === 0" style="width: 100%;height: 100%;">
