...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="120px">
      ...
      <el-form-item label="开机前温度" prop="startT">
        <el-input v-model="infoDataForm.startT" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="开机前湿度" prop="startH">
        <el-input v-model="infoDataForm.startH" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="开机后温度" prop="runT">
        <el-input v-model="infoDataForm.runT" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="开机后湿度" prop="runH">
        <el-input v-model="infoDataForm.runH" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="仪表指示(MPA)—低压" prop="meterL">
        <el-input v-model="infoDataForm.meterL" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="仪表指示(MPA)—油压" prop="meterOil">
        <el-input v-model="infoDataForm.meterOil" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="仪表指示(MPA)—高压" prop="meterH">
        <el-input v-model="infoDataForm.meterH" placeholder="请输入" class="formInput" />
      </el-form-item>
    </el-form>
    <template #footer>
