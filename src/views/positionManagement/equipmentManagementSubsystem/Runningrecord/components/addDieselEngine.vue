...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="120px">
      ...
      <el-form-item label="填表时间" prop="recordTime">
        <!-- <el-input v-model="infoDataForm.cyjccrq" placeholder="请输入" class="formInput" /> -->
        <el-date-picker
      ...
      <el-form-item label="机油压力（右）" prop="sumpR">
        <el-input v-model="infoDataForm.sumpR" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="机油压力（左）" prop="sumpL">
        <el-input v-model="infoDataForm.sumpL" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="机油温度" prop="sumpT">
        <el-input v-model="infoDataForm.sumpT" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="冷却水温度" prop="waterT">
        <el-input v-model="infoDataForm.waterT" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="油底壳机油平面—静" prop="sumpLevelStat">
        <el-input v-model="infoDataForm.sumpLevelStat" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="油底壳机油平面—动" prop="sumpLevelDyna">
        <el-input v-model="infoDataForm.sumpLevelDyna" placeholder="请输入" class="formInput" />
      </el-form-item>
    </el-form>
    <template #footer>
