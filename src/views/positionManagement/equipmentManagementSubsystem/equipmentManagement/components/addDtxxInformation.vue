...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="120px">
      ...
      <el-form-item label="载重（kg）" prop="zz">
        <el-input v-model="infoDataForm.zz" placeholder="请输入" class="formInput" />
      </el-form-item>
      ...
      <el-form-item label="生产产家" prop="sccj">
      ...
      <el-form-item label="箱体尺寸（m3）" prop="xtcc">
        <el-input v-model="infoDataForm.xtcc" placeholder="请输入" class="formInput" />
      </el-form-item>
