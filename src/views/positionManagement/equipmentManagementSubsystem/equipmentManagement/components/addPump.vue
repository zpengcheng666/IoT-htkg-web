...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="120px">
      ...
      <el-form-item label="流量(m3/h)" prop="ll">
        <el-input v-model="infoDataForm.ll" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="扬程(m)" prop="yc">
        <el-input v-model="infoDataForm.yc" placeholder="请输入" class="formInput" />
      </el-form-item>
