...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="120px">
      ...
      <el-form-item label="构筑方式" prop="gzfs">
        <el-input v-model="infoDataForm.gzfs" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="抗压强度（Mpa）" prop="kyqd">
        <el-input v-model="infoDataForm.kyqd" placeholder="请输入" class="formInput" />
      </el-form-item>
      ...
      <el-form-item label="类型" prop="lx">
        <el-input v-model="infoDataForm.lx" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="开启方式" prop="kqfs">
        <el-input v-model="infoDataForm.kqfs" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="外型尺寸" prop="wxcc">
        <el-input v-model="infoDataForm.wxcc" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="材质" prop="cz">
        <el-input v-model="infoDataForm.cz" placeholder="请输入" class="formInput" />
      </el-form-item>
