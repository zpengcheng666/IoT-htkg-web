...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="120px">
      ...
      <el-form-item label="额定功率" prop="edgl">
      ...
      <el-form-item label="风量(M3/h)" prop="fl">
        <el-input v-model="infoDataForm.fl" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="风压(mPa)" prop="fy">
        <el-input v-model="infoDataForm.fy" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="电机出厂编号" prop="djccbh">
        <el-input v-model="infoDataForm.djccbh" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="电机生产厂家" prop="djsccj">
        <el-input v-model="infoDataForm.djsccj" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="电机出厂日期" prop="djccrq">
        <!-- <el-input v-model="infoDataForm.cyjccrq" placeholder="请输入" class="formInput" /> -->
        <el-date-picker
          v-model="infoDataForm.djccrq"
          type="date"
          label="出厂日期"
          placeholder="出厂日期"
          style="width: 260px;"
      ...
      <el-form-item label="电机型号规格" prop="djxhgg">
        <el-input v-model="infoDataForm.djxhgg" placeholder="请输入" class="formInput" />
      </el-form-item>
