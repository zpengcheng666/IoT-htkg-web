...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="120px">
      ...
      <el-form-item label="型号规格" prop="ggxh">
      ...
      <el-form-item label="外形尺寸" prop="wxcc">
        <el-input v-model="infoDataForm.wxcc" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="容积(m3)" prop="rj">
        <el-input v-model="infoDataForm.rj" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="构筑方式" prop="gzfs">
        <el-input v-model="infoDataForm.gzfs" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="储存油类" prop="ccyl">
        <el-input v-model="infoDataForm.ccyl" placeholder="请输入" class="formInput" />
      </el-form-item>
    </el-form>
    <template #footer>
