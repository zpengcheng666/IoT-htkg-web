...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="120px">
      ...
      <el-form-item label="面积（m2）" prop="mj">
        <el-input v-model="infoDataForm.mj" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="装修方式" prop="zxfs">
        <el-input v-model="infoDataForm.zxfs" placeholder="请输入" class="formInput" />
      </el-form-item>
