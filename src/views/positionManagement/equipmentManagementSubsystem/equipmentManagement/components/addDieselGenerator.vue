...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :model="infoDataForm" :inline="true" class="demo-form-inline" label-width="150px">
      <el-form-item label="设备名称" prop="sbmc">
        <el-input v-model="infoDataForm.sbmc" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="柴油机型号" prop="cyjxh">
        <el-input v-model="infoDataForm.cyjxh" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="柴油机出厂编号" prop="cyjccbh">
        <el-input v-model="infoDataForm.cyjccbh" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="柴油机生产厂家" prop="cyjsccj">
        <el-input v-model="infoDataForm.cyjsccj" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="柴油机出厂日期" prop="cyjccrq">
        <!-- <el-input v-model="infoDataForm.cyjccrq" placeholder="请输入" class="formInput" /> -->
        <el-date-picker
          v-model="infoDataForm.cyjccrq"
          type="date"
          label="出厂日期"
          placeholder="出厂日期"
          style="width: 260px;"
      ...
      <el-form-item label="发电机型号" prop="fdjxh">
        <el-input v-model="infoDataForm.fdjxh" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="发电机出厂编号" prop="fdjccbh">
        <el-input v-model="infoDataForm.fdjccbh" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="发电机生产厂家" prop="fdjsccj">
        <el-input v-model="infoDataForm.fdjsccj" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="发电机出厂日期" prop="fdjccrq">
        <!-- <el-input v-model="infoDataForm.fdjccrq" placeholder="请输入" class="formInput" /> -->
        <el-date-picker
          v-model="infoDataForm.fdjccrq"
          type="date"
          label="发电机出厂日期"
          placeholder="发电机出厂日期"
          style="width: 260px;"
      ...
      <el-form-item label="额定输出功率(KW)" prop="edscgl">
        <el-input v-model="infoDataForm.edscgl" placeholder="请输入" class="formInput" />
      </el-form-item>
      <el-form-item label="累计运行时间" prop="ljyxsj">
        <el-input v-model="infoDataForm.ljyxsj" placeholder="请输入" class="formInput" />
      </el-form-item>
      ...
      <el-form-item label="末次等级保养运行时间" prop="mcdjbyyxsj">
        <el-input v-model="infoDataForm.mcdjbyyxsj" placeholder="请输入" class="formInput" />
      </el-form-item>
