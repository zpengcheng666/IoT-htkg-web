...
<template>
  ...
  >
    <el-form ref="ruleFormRef" :rules="rules" :model="infoDataForm" class="demo-form-inline" label-width="100px">
      <el-form-item label="字典类型" placeholder="请输入" prop="name">
        <el-input v-model="infoDataForm.name" class="formInput" />
      </el-form-item>
      <!-- <el-form-item label="角色状态" placeholder="请输入" class="formInput">
        <el-input v-model="infoDataForm.region" />
      </el-form-item> -->
      <el-form-item label="字典码值" placeholder="请输入" prop="enName">
        <el-input v-model="infoDataForm.enName" class="formInput" />
      </el-form-item>
    </el-form>
    <template #footer>
